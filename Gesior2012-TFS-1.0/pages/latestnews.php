  ...
  $featuredArticle = '<div id="featuredarticle" class="Box">
    ...
    if(isset($last_threads[0]))
    {
        foreach($last_threads as $thread)
        {
            ...
            <tr>'.showPost('', $thread['post_text'], $thread['post_smile']).'</tr><tr><td><div style="text-align:right;margin:10px 10px 0 0;"><a href="?subtopic=forum&action=show_thread&id=' . $thread['id'] . '">» Skomentuj</a></div></td></tr></tbody>
            </table>
            <br>';
        }
    }
