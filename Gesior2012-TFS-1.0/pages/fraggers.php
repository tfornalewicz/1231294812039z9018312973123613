<?php
	...
	$main_content .= '
		<div style="text-align: center; font-weight: bold;">Najwięksi zabójcy na serwerze</div>
		<br><table border="0" cellspacing="1" cellpadding="4" width="100%">
		<tr bgcolor="' . $config['site']['vdarkborder'] . '">
			<td class="white" style="text-align: center; font-weight: bold;">Nick</td>
			<td class="white" style="text-align: center; font-weight: bold;">Ilość zabójstw</td>
		</tr>
	';
