...
$main_content .= '<center><h2>Domki</h2></center>';

$main_content .= '<form action="" method="GET"><input type="hidden" name="subtopic" value="houses" /><table width="100%"><tr style="background-color:' . $config['site']['vdarkborder'] . ';font-weight:bold"><td style="color:white"><center>Miasto</center></td><td style="color:white"><center>Właściciel</center></td><td style="color:white"><center>Sortuj wg</center></td></tr>';
...
$main_content .= '<input type="radio" name="owner" value="2" id="radio_o2" ' . (($selected_owner == 2) ? 'checked="checked"' : '') . '/><label for="radio_o2">Wszystkie</label><br />';
$main_content .= '<input type="radio" name="owner" value="0" id="radio_o0" ' . (($selected_owner == 0) ? 'checked="checked"' : '') . '/><label for="radio_o0">Wolne</label><br />';
$main_content .= '<input type="radio" name="owner" value="1" id="radio_o1" ' . (($selected_owner == 1) ? 'checked="checked"' : '') . '/><label for="radio_o1">Wynajęte</label>';
$main_content .= '</td>';
...
$main_content .= '<td style="vertical-align:top">';
$main_content .= '<input type="radio" name="order" value="name" id="radio_s0" ' . (($selected_order == 'name') ? 'checked="checked"' : '') . '/><label for="radio_s0">Nazwa ulicy</label><br />';
$main_content .= '<input type="radio" name="order" value="size" id="radio_s1" ' . (($selected_order == 'size') ? 'checked="checked"' : '') . '/><label for="radio_s1">Rozmiar (w sqm)</label>';
...
if(isset($_REQUEST['town']) && isset($_REQUEST['owner']) && isset($_REQUEST['order']))
{
	...
	$main_content .= '<table width="100%"><tr style="background-color:' . $config['site']['vdarkborder'] . ';font-weight:bold"><td style="color:white"><center>Ulica</center></td><td style="color:white"><center>Właściciel</center></td><td style="color:white"><center>Rozmiar</center></td></tr>' . $housesText . '</table>';
}